...
(function () {
  ...
  const FA = {
    ...
    "Remove": "حذف",
    "Breakfast": "صبحانه",
    "Egg Breakfasts": "صبحانه تخم مرغ",
    "Hot Breakfasts": "صبحانه گرم",
    "Bread and Dairy": "نان و لبنیات",
    ...
    "Lentil Stew": "خوراک عدسی",
    "Bean Stew": "خوراک لوبیا",
    "Omelet": "املت",
    "Fried Egg": "نیمرو",
    "Bread and Clotted Cream": "نان و سرشیر",
    "Bread and Cheese": "نان و پنیر",
    "Tea": "چای",
    "Bean Stew with Mushrooms": "خوراک لوبیا با قارچ",
    "Tea with Dates": "چای + خرما",
    "Bread, Butter and Jam": "نان کره مربا",
    "Turkish Coffee": "قهوه ترک",
    "Boiled Egg": "تخم مرغ آب پز",
    "Kolbe Special Cake": "کیک ویژه کلبه",
    "Chocolate Cake": "کیک شکلات",
    ...
    "Hot breakfast": "صبحانه گرم",
    "Traditional": "سنتی",
    "Hearty": "مقرنی",
    "Egg breakfast": "صبحانه تخم مرغ",
    "Fresh": "تازه",
    "Classic": "کلاسیک",
    "Sunny side up": "نیمرو",
    "Bread and dairy": "نان و لبنیات",
    ...
    "Fresh brewed": "دم‌کرده تازه",
    "With mushrooms": "با قارچ",
    "With dates": "با خرما",
    "Sweet": "شیرین",
    "Strong": "قوی",
    "Soft boiled": "آب‌پز",
    "Rich": "پرچرب",
    "With rock candy": "با نبات",
    "Homemade": "خانگی",
    ...
    "Hot breakfast, Traditional, Hearty": "صبحانه گرم، سنتی، مقرنی",
    "Egg breakfast, Fresh, Classic": "صبحانه تخم مرغ، تازه، کلاسیک",
    "Egg breakfast, Sunny side up, Classic": "صبحانه تخم مرغ، نیمرو، کلاسیک",
    "Bread and dairy, Traditional, Creamy": "نان و لبنیات، سنتی، خامه‌ای",
    "Bread and dairy, Simple, Classic": "نان و لبنیات، ساده، کلاسیک",
    "Hot drink, Fresh brewed, Classic": "نوشیدنی گرم، دم‌کرده تازه، کلاسیک",
    "Hot breakfast, With mushrooms, Hearty": "صبحانه گرم، با قارچ، مقرنی",
    "Hot drink, With dates, Traditional": "نوشیدنی گرم، با خرما، سنتی",
    "Bread and dairy, Sweet, Classic": "نان و لبنیات، شیرین، کلاسیک",
    "Hot drink, Strong, Traditional": "نوشیدنی گرم، قوی، سنتی",
    "Egg breakfast, Soft boiled, Classic": "صبحانه تخم مرغ، آب‌پز، کلاسیک",
    "House specialty, Fresh baked": "ویژه رستوران، تازه پخته‌شده",
    "Fresh baked, Rich": "تازه پخته‌شده، پرچرب",
